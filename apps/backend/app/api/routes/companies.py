...
async def patch_current_company(
    ...
    company = await update_company(
        ...
        remittance_name=payload.remittance_name,
        remittance_address_line1=payload.remittance_address_line1,
        remittance_address_line2=payload.remittance_address_line2,
        remittance_city=payload.remittance_city,
        remittance_state=payload.remittance_state,
        remittance_postal_code=payload.remittance_postal_code,
